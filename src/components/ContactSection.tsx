...
const ContactSection = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      // Replace with actual API endpoint when integrated with Brevo
  ...
  return (
    <section id="contact" className="bg-primary text-primary-foreground">
      <div className="container">
        <h2 className="section-title text-primary-foreground after:bg-accent">Let's Connect</h2>
        
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6 animate-fade-in">
            <h3 className="text-2xl font-bold">Reach Out</h3>
            <p className="text-primary-foreground/80 max-w-md">
              Let's discuss software engineering opportunities. I'm currently available for full-time roles 
              and interesting projects where I can make a meaningful impact.
            </p>
            ...
            <div className="pt-8">
              <p className="font-mono text-sm text-primary-foreground/60">
                From aircraft to algorithms, my journey has prepared me to solve complex problems with precision and creativity.
              </p>
            </div>
          </div>
